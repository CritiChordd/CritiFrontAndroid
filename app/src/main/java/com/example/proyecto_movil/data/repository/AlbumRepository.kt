...
class AlbumRepository @Inject constructor(
    ...
    suspend fun getAllAlbums(): Result<List<AlbumInfo>> {
        return try {
            ...
            println("AlbumRepository - Error en getAllAlbums: ${e.message}")
            Result.failure(e)
        }
    }
    ...
    suspend fun getAlbumById(id: Int): Result<AlbumInfo> {
        return try {
            ...
            println("AlbumRepository - Error en getAlbumById: ${e.message}")
            Result.failure(e)
        }
    }
    ...
    suspend fun createAlbum(request: CreateAlbumDto): Result<AlbumInfo> {
        return try {
            ...
            println("AlbumRepository - Error en createAlbum: ${e.message}")
            Result.failure(e)
        }
    }
}
